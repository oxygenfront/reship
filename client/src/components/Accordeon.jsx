  ...
  return (
    <section className='faq' id='faq'>
      <div className='container faq__container'>
        <div className='faq__title'>Часто задаваемые вопросы/ответы</div>
        <hr className='hr' />
        <div className='faq__accordeon'>
          ...
          <div
            ...
            onClick={() => setAccordeon({ second_item: !(accordeon.second_item) })}
          >
            <div className='faq__item-first-block'>
              <div className='faq__item-title'>
          ...
          <div
            ...
            onClick={() => setAccordeon({ fourth_item: !(accordeon.fourth_item) })}
          >
            <div className='faq__item-first-block'>
              <div className='faq__item-title'>
