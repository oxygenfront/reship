    ...
    <section className="person">
      <div className="container person__container">
        ...
        <div className="person__opacity">
          ...
          <div className="person__history-wrapper" style={{ display: 'none' }}>
            <div className="person__reviews_text-block">
              <p>
                Вы еще не совершали покупок - вернитесь сюда позднее, а пока
                можете <a href="/catalog.html">перейти в каталог</a>, <br /> для
                выбора товара
              </p>
            </div>
          </div>
          ...
          <div className="person__wait-wrapper" style={{ display: 'none' }}>
            <div className="person__reviews_text-block">
              <p>
                ...
                <a href="/catalog.html">перейти в каталог</a>, для выбора товара
              </p>
            </div>
          </div>
          ...
          <div className="person__reviews">
            <div className="person__reviews_text-block">
              <p>
                <span>Мы любим своих клиентов</span> и хотим, чтобы вы делились
                своими реальными <br /> отзывами о “ReShip” и нас становилось
                все больше
              </p>
            </div>
